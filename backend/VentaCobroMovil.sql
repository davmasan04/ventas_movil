...
INSERT INTO `ventacobromovil`.`pedido` (`idPedido`, `estado`, `fechaPedido`, `ahorro`, `subtotal`, `ivatotal`, `total`, `comentario`, `idVendedor`) VALUES ('1', 'true', '12/5/21', '12.3', '45.32', '13.4', '58.72', 'comentario1', '1');
